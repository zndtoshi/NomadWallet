...
describe('BlueElectrum', () => {
  ...
  it('ElectrumClient can test connection', async () => {
    assert.ok(!(await BlueElectrum.testConnection('electrum1.nomadwallet.io', 444, false)));
    assert.ok(!(await BlueElectrum.testConnection('electrum1.nomadwallet.io', false, 444)));
    ...
    assert.ok(await BlueElectrum.testConnection('electrum1.nomadwallet.io', '50001'));
    assert.ok(await BlueElectrum.testConnection('electrum1.nomadwallet.io', false, 443));
  });
